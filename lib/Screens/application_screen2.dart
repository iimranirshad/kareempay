...
class _ApplicationScreen2State extends State<ApplicationScreen2> {
  ...
  void _submitApplication() async {
    ...
    try {
      ...
      final idBack = await _encodeFileToBase64(_file3);
      final ulitilty = await _encodeFileToBase64(_file2);
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 1.h,),
                  SubHeadings(title: 'Item to Purchase:',),
                  ApplicationFields(label: 'Item',inputType: TextInputType.text,controller: _itemController,),
                  SizedBox(height: 2.h,),
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          SizedBox(height: 0.5.h,),
                          FilesCard(title: 'Invoice', subtitle: _subtitle2,icon: Icons.upload_file_outlined,fileType: 'pdf',onFilePicked: (file, type){
                            setState(() {
                              _file5 = file;
                              _subtitle2 = 'Uploaded';
                            });

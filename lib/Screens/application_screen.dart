...
class _ApplicationScreenState extends State<ApplicationScreen> {
  ...
  void _submitApplication() async {
    ...
    try {
      ...
      final proofBack = await _encodeFileToBase64(_file2_back);
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          FilesCard(title: 'CNIC Front', subtitle: _subtitle2,flag: true,icon: Icons.add_photo_alternate_outlined,fileType: 'image',onFilePicked: (file, type){
                            setState(() {
                              _file1_back = file;
                              _subtitle2 = 'Uploaded';
                            });
                      ...
                      Column(
                        children: [
                          ...
                          SizedBox(height: 0.5.h,),
                          FilesCard(title: 'CNIC Back', subtitle: _subtitle4,flag: true,icon: Icons.add_photo_alternate_outlined,fileType: 'image',onFilePicked: (file, type){
                            setState(() {
                              _file2_back = file;
                              _subtitle = 'Uploaded';
                            });

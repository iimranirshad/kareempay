    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text('Ijara',style: GoogleFonts.poppins(
                fontSize: 15.sp,
                fontWeight: FontWeight.w600,
                color: secondary
            ),),
            Text('Loan Portal',style: GoogleFonts.poppins(
                fontSize: 11.sp,
                fontWeight: FontWeight.w600,
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ApplicationFields(label: 'Time',inputType: TextInputType.number,controller: _loanTime,),
                  SizedBox(height: 1.h,),
                  ...
                  SizedBox(height: 1.h,),
                  SubHeadings(title: 'Asset to Lease:',),
                  ApplicationFields(label: 'Asset',inputType: TextInputType.text,controller: _assetlease,),
                  SizedBox(height: 1.h,),
                  SubHeadings(title: 'Lease Duration:',),
                  ApplicationFields(label: 'Duration',inputType: TextInputType.number,controller: _leaseduration,),
                  SizedBox(height: 2.h,),
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          FilesCard(title: 'Income Proof', subtitle: _subtitle2,icon: Icons.upload_file_outlined,fileType: 'pdf',onFilePicked: (file, type){
                            setState(() {
                              _file4 = file;
                              _subtitle2 = 'Uploaded';
                            });
                          ...
                          SizedBox(height: 0.5.h,),
                          FilesCard(title: 'PurchasePlan', subtitle: _subtitle5,icon: Icons.upload_file_outlined,fileType: 'pdf',onFilePicked: (file, type){
                            setState(() {
                              _file5 = file;
                              _subtitle5 = 'Uploaded';
                            });
                      ...
                      Column(
                        children: [
                          ...
                          SizedBox(height: 0.5.h,),
                          FilesCard(title: 'Utility Bill', subtitle: _subtitle4,icon: Icons.upload_file_outlined,fileType: 'pdf',onFilePicked: (file, type){
                            setState(() {
                              _file3 = file;
                              _subtitle4 = 'Uploaded';
                            });
                          ...
                          SizedBox(height: 0.5.h,),
                          FilesCard(title: 'Business Plan', subtitle: _subtitle6,icon: Icons.upload_file_outlined,fileType: 'pdf',onFilePicked: (file, type){
                            setState(() {
                              _file6 = file;
                              _subtitle6 = 'Uploaded';
                            });
                  ...
                  SizedBox(height: 2.h,),
                  Center(child: GestureDetector(child: UserButton(color: Color(0xffD3D3D3), text: 'Submit', text_color: primary, height: 6, width: 28,),onTap:_submitApplication,)),
                  SizedBox(height: 3.h,)
                ],
              ),
            ),
